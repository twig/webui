...
export var SpeedGraph = new Class({
  ...
  draw: function() {
    if (
      !(utWebUI.config || {}).showDetails ||
      utWebUI.mainTabs.active != "mainInfoPane-speedTab"
    )
      return;
    this.plot.repaint();
  },
  ...
  setLabels: function(upLabel, downLabel) {
    if (typeof upLabel !== "undefined") this.plot.series[0].label = upLabel;
    if (typeof downLabel !== "undefined") this.plot.series[1].label = downLabel;
  },
